...
function OpenAIKeyPage({ apiKey, onApiKeyChange, onNext, onPrev, onSkip }) {
  const [showPassword, setShowPassword] = useState(false);

  return (
    <div className="setup-page active" data-page="3">
      <div className="setup-api-icon openai">
      ...
      <h2 className="setup-title">OpenAI API Key</h2>
      <p className="setup-description">
        Enter your OpenAI API key to enable GPT models. Get one from{' '}
